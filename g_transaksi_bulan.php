...
<center>
  <span style="font-size:16px; font-family:Tahoma, Geneva, sans-serif"><strong>STATISTIK DATA PENDAPATAN BULANAN</strong></span>
</center>
<br />
...
<form action="r_transaksi_bulanan.php" method="POST" target="_blank">
