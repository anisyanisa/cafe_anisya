...
$a=mysqli_query($conn,"select * from menu,menukategori,kategori where kategori.id_kategori=menukategori.id_kategori AND menukategori.id_menu=menu.id_menu AND kategori.id_kategori='$kategori' order by kategori.id_kategori") or die(mysql_error());

$rk=mysqli_query($conn,"select * from kategori where id_kategori='$kategori'");
$rkk=mysqli_fetch_array($rk);
...
<tr>
    <th colspan="3"><div align="left"><strong>REPORT MENU</strong><br /><br />
    Kategori : <?php echo $rkk['nama_kategori']; ?></div></th>
</tr>
<tr>
...
<table width="600" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
      <td colspan="3"></td>
      <td colspan="2" align="center"></br>Padang,  <?php //echo $hari[date("w")].", ".date("j")." ".$bulan[date("n")]." ".date("Y");
	  echo $date;?></td>
   </tr>
   <tr>
      <td colspan="3"></td>
