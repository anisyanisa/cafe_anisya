...
<?php
	...
	if(isset($_POST['id_waitress']))
           ...
           
            {
                ...
                $query = "INSERT INTO layanan_waitress VALUES('$no_transaksi','$value')";
...
<table width="319" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="139" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>&nbsp;</td>
        <td colspan="2" align="left" scope="row">VIP Room :</td>
        </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        <td width="15">&nbsp;</td>
        <td align="left" scope="row" width="60">Sub Total</td>
      ...
      <tr>
        ...
        <td align="left" scope="row">Diskon</td><?php
								...
								?>
        <td valign="top">: <?php echo $diskon; ?>%</td>
      </tr>
      <tr>
        <th scope="row">&nbsp;</th><?php
                                  $grandtotal=$totals-$disc+$ppn;
                                ?>
...
?>         
                ...
                <div class="row">
                    <div class="col-lg-6"><button class="btn btn-warning" type="button" href="javascript:void(0);" onClick="javascript:window.print();">Cetak Bukti</button>
