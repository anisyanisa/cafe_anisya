                            ...
                            <tbody>
                                ...
                                <?php
                                  ...
                                  /*
                                    ...
                                    $res=mysql_query("SELECT menu.id_menu,menu.nama_menu,menu.harga,kategori.id_kategori,kategori.nama_kategori,menukategori.id_menu,menukategori.id_kategori FROM menu,menukategori,kategori WHERE menu.id_menu=menukategori.id_menu AND kategori.id_kategori=menukategori.id_kategori") or die(mysql_error());
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                      ...
                                      <select class="form-control chosen-select" name="id_kategori" data-placeholder="Pilih Kategori">
                                        ...
                                        <option></option>
                                        <?php 
                                        $que=mysql_query("SELECT id_kategori,nama_kategori FROM kategori") or die(mysql_error());
