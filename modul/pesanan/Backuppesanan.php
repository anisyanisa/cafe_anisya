              ...
              <h1><img width="70px" src="assets/images/avtar/Dining.png" alt="...">Data Pemesanan</h1></div>
                ...
                <div class="panel panel-default">
                    ...
                    <?php if($r['level']=='pimpinan'){ ?>
                      ...
                      <?php }else{ ?> <!-- Akhir IF-->
                            <div class="panel-heading"><a href="?modul=pesan&act=add" class="btn btn-primary">Tambah Data</a></div>
                            <div class="panel-body">
...
*/
  $queryPeriksa = mysqli_query($conn,"SELECT * FROM pesanan");
  $di=1;
  $tot = array();
...
$iduser=$_SESSION['username'];
        ...
        //include "config/koneksi.php";
        $cariuser=mysqli_query($conn,"SELECT * FROM user WHERE username='$iduser'") or die (mysqli_error($conn));  
        $rcariuser=mysqli_fetch_array($q); 
		
      $namakasir=$rcariuser['namauser'];
		$d=mysqli_query($conn,"select * from kasir where nama_kasir='$namakasir'")or die (mysqli_error($conn));
                            ...
                            <form class="form-horizontal" role="form" action="modul/pesanan/simpan.php" method="POST">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-7" style="overflow:auto; height:300px">
                                        ...
                                        <?php 
                                        $n=1;
                                        $qu=mysqli_query($conn,"SELECT menu.id_menu,menu.nama_menu,menu.harga,kategori.id_kategori,kategori.nama_kategori,menukategori.id_menu,menukategori.id_kategori FROM menu,menukategori,kategori WHERE menu.id_menu=menukategori.id_menu AND kategori.id_kategori=menukategori.id_kategori AND kategori.nama_kategori like '%Makanan%'") or die(mysqli_error($conn));
...
<?php 
    ...
    $q=mysqli_query($conn,"SELECT menu.id_menu,menu.nama_menu,menu.harga,kategori.id_kategori,kategori.nama_kategori,menukategori.id_menu,menukategori.id_kategori FROM menu,menukategori,kategori WHERE menu.id_menu=menukategori.id_menu AND kategori.id_kategori=menukategori.id_kategori AND menukategori.id_menu='$id'") or die(mysqli_error($conn));
