<?php
   ...
   $kd_kasir=$_POST['kd_kasir'];
    ...
    $b=mysqli_query($conn,"UPDATE kasir SET nik='$nik',nama_kasir='$nama_kasir',jekel='$jekel',tempat_lahir='$tempat_lahir',tanggal_lahir='$tanggal_lahir',alamat_kasir='$alamat_kasir',nohp_kasir='$nohp_kasir',tgl_bergabung='$tgl_bergabung' WHERE kd_kasir='$kd_kasir'") or die(mysqli_error($conn));
