...
$a=mysql_query("SELECT cek_in.tanggalmasuk, COUNT(cek_in.idpasien) as jlh FROM cek_in WHERE cek_in.tanggalmasuk LIKE '$bulan%' GROUP BY tanggalmasuk") or die(mysql_error());
...
<tr>
    <th colspan="3"><div align="center">Periode: <?php echo DateToIndo($bulan); ?></tr></div></th>
</tr>
</table>
...
<table width="600" border="0" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <th class="line_ba line_a line_ki"><div >TANGGAL</div></th>
    <th class="line_ba line_ka line_ki line_a"><div align="center">JUMLAH PASIEN</div></th>
  </tr>
  <?php $no=1; while ($aa=mysql_fetch_array($a)){ $total=$total+$aa['jlh']?>
  <tr>
    <td align="center" class="line_ki line_ba"><?php echo $no; ?></td>
    <td align="center" class="line_ki line_ba"><?php echo ubahFormatZ($aa['tanggalmasuk']);?></td>
    <td align="center" class='line_ki line_ka line_ba'><?php echo $aa['jlh'];?> Orang</td>
  </tr>
  <?php $no++; } ?>
  <tr>
    <td colspan="2" class="line_ki line_ba" align="center"><strong>TOTAL</strong></td>
    <td class="line_ki line_ka line_ba" align="center"><strong><?php echo $total;?> Orang</strong></td>
  </tr>
   <?php
