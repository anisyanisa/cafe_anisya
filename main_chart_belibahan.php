...
<div class="page-header"><h1>Report Pembelian Bahan </h1></div>
              ...
              <div class="col-md-12">
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" action="r_belibahan_periode.php" method="POST" target="_blank">
                            ...
                            <form class="form-horizontal" role="form" action="r_belibahan_bulan.php" method="POST" target="_blank">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                      ...
                                      <select class="form-control chosen-select col-sm-3" required name="bulan" data-placeholder="Pilih Bulan">
                                        ...
                                        <option></option>
                                        <?php 
                                        $qu=mysql_query("SELECT tgl_transaksi FROM belibahan GROUP BY MONTH(tgl_transaksi),YEAR(tgl_transaksi)") or die(mysql_error());
                          ...
                          <form class="form-horizontal" role="form" action="g_belibahan_tahun.php" method="POST" target="_blank">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select class="form-control chosen-select col-sm-3" required name="tahun" data-placeholder="Pilih Tahun">
                                        ...
                                        <option></option>
                                        <?php 
                                        $qu=mysql_query("SELECT YEAR(tgl_transaksi) as tahun FROM belibahan GROUP BY YEAR(tgl_transaksi)") or die(mysql_error());
                                        while($ro=mysql_fetch_array($qu)){ 
