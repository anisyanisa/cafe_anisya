...
<div class="page-header"><h1>&nbsp;Statistik Jumlah Pendapatan</h1></div>
              ...
              <div class="col-md-12">
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" action="g_transaksi_periode.php" method="POST" target="_blank">
                            ...
                            <form class="form-horizontal" role="form" action="g_transaksi_bulan.php" method="POST" target="_blank">
                          ...
                          <form class="form-horizontal" role="form" action="g_transaksi_tahun.php" method="POST" target="_blank">
