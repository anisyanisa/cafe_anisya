...
$a=mysql_query("select dokter.iddokter,dokter.namadokter,count(cek_in.idpasien) as jlh FROM cek_in,dokter WHERE cek_in.iddokter=dokter.iddokter AND  cek_in.tanggalmasuk LIKE '$tahun%' GROUP BY cek_in.iddokter") or die(mysql_error());
...
<tr>
    <th colspan="3"><p align="center"><strong>LAPORAN JUMLAH PASIEN per DOKTER</strong></p></th>
</tr>
<tr>
...
<table width="600" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <th class="line_ba line_ki line_ka line_a"><div align="center">NO.</div></th>
    <th class="line_ba line_ka line_a"><div align="center">ID DOKTER</div></th>
    <th class="line_ba line_ka line_a"><div >NAMA DOKTER</div></th>
    <th class="line_ba line_ka line_a"><div align="center">JUMLAH PASIEN</div></th>
  </tr>
  <?php $no=1; while ($aa=mysql_fetch_array($a)){ $total=$total+$aa['jlh']; ?>
  <tr>
    <td align="center" class="line_ki line_ka line_ba"><?php echo $no; ?></td>
    <td align="center" class="line_ka line_ba"><?php echo $aa['iddokter'];?></td>
    <td class="line_ka line_ba"><?php echo $aa['namadokter'];?></td>
    <td align="center" class="line_ka line_ba"><?php echo $aa['jlh'];?></td>
  </tr>
  <?php $no++; } ?>
  <tr>
    <td colspan="3" class="line_ki line_ka line_ba" align="center"><strong>TOTAL</strong></td>
